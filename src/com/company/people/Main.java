...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(programmer.getName()+" "+programmer.getAge()+" "+programmer.getDesignation()+". "
                +programmer.toString());
        ...
        System.out.println(doctor.getName()+" "+doctor.getAge()+" "+doctor.getDesignation()+". "
                +doctor.toString());
        ...
        System.out.println(musician.getName()+" "+musician.getAge()+" "+musician.getDesignation()+". "
        + musician.toString());
